...
static const char * const dummy1_groups[] = { "gpio68" };
...
static const char * const dummy2_groups[] = { "gpio70" };
...
static const char * const dummy0_groups[] = { "gpio104" };
...
static const char * const dummy3_groups[] = { "gpio124" };
static const char * const dummy4_groups[] = { "gpio125" };
...
static const struct pinfunction msm8952_functions[] = {
	...
	MSM_PIN_FUNCTION(dummy3),
	MSM_PIN_FUNCTION(dummy4),
};
...
static const struct msm_pingroup msm8952_groups[] = {
	...
	PINGROUP(4, blsp_spi2, blsp_uart2, ldo_update, NA, atest_combodac_to_gpio_native, NA, NA, NA, NA),
	...
	PINGROUP(7, blsp_spi2, blsp_uart2, blsp_i2c2, NA, NA, atest_gpsadc_dtest0_native, NA, NA, NA),
	PINGROUP(8, blsp_spi3, blsp_uart3, sec_mi2s, pbs0, NA, NA, NA, NA, NA),
	PINGROUP(9, blsp_spi3, blsp_uart3, sec_mi2s, pbs1, pwr_modem_enabled_b, NA, NA, NA, NA),
	PINGROUP(10, blsp_spi3, blsp_uart3, blsp_i2c3, gcc_gp2_clk_b, NA, NA, NA, NA, NA),
	PINGROUP(11, blsp_spi3, blsp_uart3, blsp_i2c3, gcc_gp3_clk_b, NA, NA, NA, NA, NA),
	PINGROUP(12, blsp_spi4, blsp_uart4, sec_mi2s, pbs2, pwr_nav_enabled_b, NA, NA, NA, NA),
	PINGROUP(13, blsp_spi4, blsp_uart4, sec_mi2s, pwr_crypto_enabled_b, NA, NA, NA, NA, NA),
	PINGROUP(14, blsp_spi4, blsp_uart4, blsp_i2c4, NA, NA, NA, NA, NA, NA),
	PINGROUP(15, blsp_spi4, blsp_uart4, blsp_i2c4, NA, NA, NA, NA, NA, NA),
	PINGROUP(16, blsp_spi5, blsp_uart5, NA, NA, NA, NA, qdss_traceclk_a, NA, atest_bbrx1),
	...
	PINGROUP(20, blsp_spi6, blsp_uart6, NA, NA, NA, NA, NA, NA, qdss_tracectl_b),
	PINGROUP(21, blsp_spi6, blsp_uart6, m_voc, NA, NA, NA, NA, NA, qdss_cti_trig_in_b0),
	...
	PINGROUP(25, mdp_vsync, pri_mi2s_mclk_a, sec_mi2s_mclk_a, NA, NA, NA, NA, NA, NA),
	PINGROUP(26, cam_mclk, NA, NA, NA, NA, NA, qdss_tracedata_a, NA, NA),
	PINGROUP(27, cam_mclk, NA, NA, NA, NA, NA, NA, NA, qdss_tracedata_a),
	PINGROUP(28, cam_mclk, NA, NA, NA, NA, NA, qdss_tracedata_a, NA, atest_combodac_to_gpio_native),
	PINGROUP(29, cci_i2c, pwr_modem_enabled_a, NA, NA, NA, NA, NA, qdss_tracedata_a, NA),
	...
	PINGROUP(35, pwr_nav_enabled_a, NA, NA, NA, NA, NA, NA, NA, qdss_tracedata_a),
	PINGROUP(36, pwr_crypto_enabled_a, NA, NA, NA, NA, NA, NA, NA, qdss_tracedata_a),
	PINGROUP(37, NA, NA, NA, NA, NA, qdss_tracedata_a, NA, NA, NA),
	PINGROUP(38, NA, qdss_tracedata_a, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(39, cci_async, NA, NA, NA, NA, NA, qdss_tracedata_a, NA, atest_combodac_to_gpio_native),
	PINGROUP(40, NA, NA, NA, NA, qdss_tracedata_a, NA, atest_combodac_to_gpio_native, NA, NA),
	PINGROUP(41, sd_write, NA, NA, NA, NA, NA, NA, qdss_cti_trig_out_a0, NA),
	PINGROUP(42, gcc_gp1_clk_a, qdss_tracedata_b, NA, atest_combodac_to_gpio_native, NA, NA, NA, NA, NA),
	PINGROUP(43, gcc_gp2_clk_a, qdss_tracedata_b, NA, atest_combodac_to_gpio_native, NA, NA, NA, NA, NA),
	PINGROUP(44, gcc_gp3_clk_a, qdss_tracedata_b, NA, atest_combodac_to_gpio_native, NA, NA, NA, NA, NA),
	PINGROUP(45, NA, qdss_tracedata_b, NA, atest_combodac_to_gpio_native, NA, NA, NA, NA, NA),
	PINGROUP(46, NA, qdss_tracedata_b, NA, atest_combodac_to_gpio_native, NA, NA, NA, NA, NA),
	PINGROUP(47, blsp6_spi, NA, qdss_tracedata_b, NA, atest_combodac_to_gpio_native, NA, NA, NA, NA),
	PINGROUP(48, blsp6_spi, NA, qdss_cti_trig_in_b1, NA, atest_combodac_to_gpio_native, NA, NA, NA, NA),
	...
	PINGROUP(67, atest_char1, ebi_cdc, NA, atest_combodac_to_gpio_native, NA, NA, NA, NA, NA),
	...
	PINGROUP(92, blsp_spi7, blsp_uart7, pri_mi2s_ws, NA, NA, NA, NA, NA, qdss_tracedata_b),
	PINGROUP(93, blsp_spi7, blsp_uart7, pri_mi2s, NA, NA, NA, NA, NA, NA),
	PINGROUP(94, wsa_io, blsp_spi7, blsp_uart7, blsp_i2c7, NA, NA, NA, NA, NA),
	PINGROUP(95, wsa_io, blsp_spi7, blsp_uart7, blsp_i2c7, NA, NA, NA, NA, NA),
	PINGROUP(96, blsp_spi8, blsp_uart8, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(97, blsp_spi8, blsp_uart8, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(98, blsp_i2c8, blsp_spi8, blsp_uart8, gcc_plltest, NA, NA, NA, NA, NA),
	PINGROUP(99, blsp_i2c8, blsp_spi8, blsp_uart8, gcc_plltest, NA, NA, NA, NA, NA),
	...
	PINGROUP(115, NA, gsm1_tx, NA, atest_combodac_to_gpio_native, NA, NA, NA, NA, NA),
